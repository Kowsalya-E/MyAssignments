...
public class Erail {
		public static void main(String[] args) throws InterruptedException {
			...
			System.out.println("List Size is " +countOfAllTrainsIncludingDuplicates);
			...
			int uniquetrainnames=setTrainNames.size();
			System.out.println("Set Size is " +uniquetrainnames);		
			/*
